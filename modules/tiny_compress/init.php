				...
				<section class="<?php echo $this->the_plugin->alias; ?>-main">
					...
					<div id="<?php echo $this->the_plugin->alias; ?>-gAnalytics-wrapper" class="panel panel-default <?php echo $this->the_plugin->alias; ?>-panel">
						...
						<div class="psp-box-update">
							<h2>What's Tiny Compress? <br/></h2>


							<p class="psp-update-text">Well, Tiny compress is a module that will help you compress images from your website.<br/> That way you can optimize big images for faster loading time on your website!</p>
